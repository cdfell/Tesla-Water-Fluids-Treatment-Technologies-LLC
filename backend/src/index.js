...
const options = {
  definition: {
    openapi: "3.0.0",
      info: {
        version: "1.0.0",
        title: "Tesla Water & Fluids Treatment Technologies LLC",
        description: "Tesla Water & Fluids Treatment Technologies LLC Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.",
      },
    servers: [
      {
...
app.use('/api/promocodes', passport.authenticate('jwt', {session: false}), promocodesRoutes);
